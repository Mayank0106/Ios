...
+ (instancetype)messageWithSenderId:(NSString *)senderId
                        ...
                        displayPicture:(NSString *)displayPicture
                               text:(NSString *)text
{
    return [[self alloc] initWithSenderId:senderId
                        senderDisplayName:displayName
                     senderDisplayPicture:displayPicture
                                     date:[NSDate date]
                                     text:text];
}
...
- (instancetype)initWithSenderId:(NSString *)senderId
               senderDisplayName:(NSString *)senderDisplayName
                senderDisplayPicture:(NSString *)senderDisplayPicture
                            date:(NSDate *)date
                            text:(NSString *)text
{
    NSParameterAssert(text != nil);

    self = [self initWithSenderId:senderId senderDisplayName:senderDisplayName senderDisplayPicture:senderDisplayPicture date:date isMedia:NO];
    if (self) {
        _text = [text copy];
    }
    return self;
                              ...
                              media:(id<JSQMessageMediaData>)media
{
    return [[self alloc] initWithSenderId:senderId
                        senderDisplayName:displayName
                        senderDisplayPicture:senderDisplayPicture
                                     date:[NSDate date]
                                    media:media];
}
                           ...
                           media:(id<JSQMessageMediaData>)media
{
    ...
    self = [self initWithSenderId:senderId senderDisplayName:senderDisplayName senderDisplayPicture: senderDisplayPicture date:date isMedia:YES];
    if (self) {
        _media = media;
    }
    return self;
                         ...
                         isMedia:(BOOL)isMedia
{
    ...
    if (self) {
        ...
        _senderDisplayPicture = [senderDisplayPicture copy];
        _date = [date copy];
...
- (BOOL)isEqual:(id)object
{
    ...
    && [self.senderDisplayPicture isEqualToString:aMessage.senderDisplayPicture]
...
{
    return [NSString stringWithFormat:@"<%@: senderId=%@, senderDisplayName=%@, senderDisplayPicture=%@, date=%@, isMediaMessage=%@, text=%@, media=%@>",
            [self class], self.senderId, self.senderDisplayName, self.senderDisplayPicture, self.date, @(self.isMediaMessage), self.text, self.media];
}
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        ...
        _senderDisplayPicture = [aDecoder decodeObjectForKey:NSStringFromSelector(@selector(senderDisplayPicture))];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:self.senderDisplayPicture forKey:NSStringFromSelector(@selector(senderDisplayPicture))];
...
- (instancetype)copyWithZone:(NSZone *)zone
{
    if (self.isMediaMessage) {
        return [[[self class] allocWithZone:zone] initWithSenderId:self.senderId
                                                 ...
                                                 senderDisplayPicture:self.senderDisplayPicture
                                                              date:self.date
                                                             media:self.media];
    }
