...
@property (weak, nonatomic) IBOutlet UILabel *lblNameInitials;
@property (weak, nonatomic) IBOutlet UILabel *lblPartyName;
@property (weak, nonatomic) IBOutlet UILabel *lblPartyDate;
@property (weak, nonatomic) IBOutlet UIImageView *imgVwParty;
...
- (IBAction)btnTappedback:(UIButton *)sender;
