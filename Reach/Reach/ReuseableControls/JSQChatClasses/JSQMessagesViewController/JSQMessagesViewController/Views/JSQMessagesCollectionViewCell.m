...
- (void)awakeFromNib
{
    ...
    self.cellBottomLabel.font = [UIFont systemFontOfSize:8.0f];
...
- (void)applyLayoutAttributes:(UICollectionViewLayoutAttributes *)layoutAttributes
{
    ...
    [self jsq_updateConstraint:self.cellTopLabelHeightConstraint
                  withConstant: customAttributes.cellTopLabelHeight]; //customAttributes.cellTopLabelHeight

    [self jsq_updateConstraint:self.messageBubbleTopLabelHeightConstraint
                  withConstant: 20]; //customAttributes.messageBubbleTopLabelHeight
...
- (void)setMediaView:(UIView *)mediaView
{
    ...
    mediaView.frame = CGRectMake(10, 10, self.messageBubbleContainerView.frame.size.width - 120, self.messageBubbleContainerView.frame.size.height - 120); //self.messageBubbleContainerView.bounds;
